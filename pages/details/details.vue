<template>
	<view class="details">
		...
		<!-- 商品的详情图 -->
		<view>
			<view><image class="detail-img" src="../../static/img/detail1.jpg" mode=""></image></view>
			<view><image class="detail-img" src="../../static/img/detail2.jpg" mode=""></image></view>
			<view><image class="detail-img" src="../../static/img/detail3.jpg" mode=""></image></view>
			<view><image class="detail-img" src="../../static/img/detail4.jpg" mode=""></image></view>
			<view><image class="detail-img" src="../../static/img/detail5.jpg" mode=""></image></view>
		</view>
		...
		onNavigationBarButtonTap(e){
			if(e.type ==='share'){
				uni.share({
					...
					"href":"http://192.168.0.108:8080/#/pages/details/details?id="+this.goodsContent.id+"",
